...
class LocalAuthDataSource @Inject constructor(
    ...
    override suspend fun isRememberLoginAndPasswordSelected(): Boolean = preference.isRememberLoginAndPasswordSelected()
...
//    }
    ...
    override suspend fun onLoginClicked(emailText: String, passwordText: String): Boolean {
        ...
        return if (isPasswordTheSame) {
            // Сохраняем значения в preference для восстановления их в полях email и password, если будет выбрана галочка

...
//            }
     ...
     *  TODO Send /json/url requests for every click the user makes, this helps to mark stations as popular and makes the database more useful to other people. (To do this, I need to know stationuuid, but I didn't save it to local database yet)

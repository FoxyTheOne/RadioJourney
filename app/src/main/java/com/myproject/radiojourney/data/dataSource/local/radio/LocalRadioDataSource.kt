...
class LocalRadioDataSource @Inject constructor(
    ...
    override suspend fun getLastUsedRadioStationUrl(): String = preferenceStorage.getLastUsedRadioStationUrl()

    override suspend fun getLastUsedRadioStationCountryCode(): String = preferenceStorage.getLastUsedRadioStationCountryCode()
